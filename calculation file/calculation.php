...
function ammonia($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
    ...
    try {
        ...
        JOIN `molecular dump`.`molecular dump` md
...
function hydrogen($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function methyl($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function pathbointActivity1($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function pathbointActivity2($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function lps($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function biofilm($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function fungal($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function tmao($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function succinic($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function lactic($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function butyrate($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function protease($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function uric($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function glutamine($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function symbiosis($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function pentose($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function lactate($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function tyrosine($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function cd($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function low($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function microbial($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function cat($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function reduced($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function polyamines($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function volatile($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
function genotoxic($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn)
{
    $microbialActivity = "";
    $symptomsActivity = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["crn"])) {
    $crn = $_POST["crn"];
    $crn = "patient_" . $crn;
    ammonia($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    hydrogen($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    methyl($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    pathbointActivity1($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    pathbointActivity2($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    lps($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    biofilm($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    fungal($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    tmao($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    succinic($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    lactic($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    butyrate($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    protease($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    uric($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    glutamine($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    symbiosis($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    pentose($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    lactate($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    tyrosine($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);


    cd($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);


    low($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    microbial($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    cat($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
    reduced($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    polyamines($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    volatile($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);

    genotoxic($servername, $username, $password, $dbname1, $dbname2, $conn3, $dbname4, $crn);
